...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2022 at 07:58 AM
...
CREATE TABLE `tbl_appointment` (
  ...
  `apt_time` varchar(10) DEFAULT NULL,
  `apt_message` text DEFAULT NULL,
  `apt_boolean` varchar(5) DEFAULT NULL
...
INSERT INTO `tbl_appointment` (`apt_id`, `useri_id`, `apt_date`, `apt_time`, `apt_message`, `apt_boolean`) VALUES
(4, 2, '2022-01-14', '10:30 AM', 'asdfasdf', 'Yes');
...
(2, 'Hero', 'try', 'Super', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'user', '6ad14ba9986e3615423dfca256d04e3f', 'user');
