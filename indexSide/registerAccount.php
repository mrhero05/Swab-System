    ...
    <div class="container p-0 m-auto">
        <div class="reg-container">
            ...
            if(isset($_GET["success"])){
                echo '
                <script>swal("Youre ready to go!", "Account Created Successfully!", "success");</script>';
            }
            if(isset($_GET["error"])){
                if($_GET["error"] == "password-not-match"){
                    echo '
                <script>swal("Oppps!", "Password not match!", "error");</script>';
                }
            }
            ?>
            ...
            <div class="reg-input">
                <form class="row g-2" action="register.inc.php" method="POST">
                    <div class="col-md-6">
                    ...
                    <div class="col-12 reg-buttons">
                        ...
                        <button  class="" type="submit" name="registerB">Register</button>
                    </div>
                </form>
            </div>
        </div>
